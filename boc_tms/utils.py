...
utils.py
--------
Small shared helpers used across the Streamlit pages: distance calculation
(for "nearby available units"), BOC-themed status color maps, and simple
time formatting used by the scheduler grid.
"""
